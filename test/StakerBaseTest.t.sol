...
contract StakerBaseTest is Test {
    ...
    address public uniswapPoolAddress_Base =
        0x33128a8fC17869897dcE68Ed026d694621f6FDfD;
    IUniswapV3Pool public uniswapPool;
    address public nonfungiblePositionManagerAddress_Base =
    ...
    function setUp() public {
        ...
        nonfungiblePositionManager = INonfungiblePositionManager(
            address(nonfungiblePositionManagerAddress_Base)
        );
        console.log("owner: %s", uniswapFactory.owner());
        address uniswapPoolAddress = uniswapFactory.createPool(
            token0,
            token1,
            3000
        );
        ...
        ERC20Mock(payable(token0)).approve(
            nonfungiblePositionManagerAddress_Base,
            100 ether
        );
        ERC20Mock(payable(token1)).approve(
            nonfungiblePositionManagerAddress_Base,
            100 ether
        );
        ...
        ERC20Mock(payable(kero)).mint(address(stakerFactory), 1000000 ether);
    }
